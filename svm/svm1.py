...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  5 19:37:35 2019
...
def doSvm(ABNORMAL_RATE, XMIN, YMIN, XMAX, YMAX):
    ####### 文件读取 #######
    X_train = np.load('../data/simulate/X_train.npy')[:,:2] 
    X_test = np.load('../data/simulate/X_test.npy')[:,:2]  
    ...
    plt.xlabel(
        "outlier train: %d/%d ; outlier test: %d/%d ; "
